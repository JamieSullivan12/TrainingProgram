...
class TrainingApp(tk.Tk):
    ...
    def button_hover(self, button, hover_color, init_color):

        def on_enter(e):
            e.widget["background"] = hover_color
        def on_leave(e):
            e.widget["background"] = init_color
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.actions_menu.add_command(label="Home", command=lambda: self.show_frame("StartPage"))
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        customers_button = tk.Button(frame, text='Customers',borderwidth=0,width=15, height=1,font=self.controller.p3, fg="#ffffff", bg=self.controller.buttonBackground,activebackground=self.controller.buttonClick,activeforeground="#ffffff", relief=tk.FLAT, command=lambda: self.controller.show_frame("CustomerPage"))
        customers_button.grid(row=2,column=0, padx=50, pady=(0,15))
        self.controller.button_hover(customers_button,self.controller.buttonClick,self.controller.buttonBackground)
