...
class AddCustomerPage(tk.Frame):
    ...
    def __init__(self, controller):
        ...
        i+=2
        self.date_label = ttk.Label(self.frame, text="Date of Birth (DD/MM/YYYY)")
        ...
        self.email_entry = ttk.Entry(self.frame, width=20)
        ...
        add_customer = ttk.Button(self.frame, text='Add Customer', command=lambda:self.add_customer())
