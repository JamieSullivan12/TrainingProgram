...
class HomePage(ttk.Frame):
    ...
    def __init__(self, mainline_obj):
        ...
        self.traineesearch_button = ttk.Button(self,text="Trainee Search", width=30,command=lambda:self.mainline_obj.showwindow("TraineeSearchPage"))
        ...
        self.addexercise_button = ttk.Button(self,text="Add Exercise",width=30, command=lambda:self.mainline_obj.showwindow("AddExercisePage"))
